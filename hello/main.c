 ...
 * hello.say_hello()
 */
  __pyx_t_2 = __Pyx_ImportDottedModule(__pyx_n_s_hello, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
 ...
 * hello.say_hello()             # <<<<<<<<<<<<<<
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_hello); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_say_hello); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 4, __pyx_L1_error)
